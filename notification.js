...
// This helps in fetching the notification upto the point where user has pauses all notifications. They wont see future ones, but still see old ones
let createdAt;
...
// These are the preferences that user sets in the settings and based on these settings, notifications shown to user are filtered. 
...
// eid from lesson UIs
// We get enorllment id to construct url so when clicked on notification, they can properly navigate to correct page 
...
// mutaion to mark notifications read
...
// fetch class ids and use these ids to fetch notifications of fetched classes
...
// Update all notification visibility
